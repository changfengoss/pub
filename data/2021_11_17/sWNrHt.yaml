...
proxies:
  - {name: '🇩🇪_DE_德国_1', server: 82.102.16.102, port: 41992, type: ss, cipher: aes-256-gcm, password: XmQSxDCn5ehpcq6DBYms8FJf}
  - {name: '🇳🇱_NL_荷兰_2', server: 89.46.223.75, port: 40220, type: ss, cipher: aes-256-gcm, password: ugyBkSEFxVEmUYSHyvxmWNj9}
  - {name: '🇳🇴_NO_挪威_3', server: 91.219.215.53, port: 42304, type: ss, cipher: aes-256-gcm, password: p26v2JwhQVHDHsXk66fXt56r}
  - {name: '🇳🇱_NL_荷兰_4', server: 89.46.223.81, port: 47121, type: ss, cipher: aes-256-gcm, password: CTK8GXFQgKYQErrghPJfZ6tk}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
