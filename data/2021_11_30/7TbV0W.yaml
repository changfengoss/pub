...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 142.202.48.105, port: 5004, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇨🇦_CA_加拿大_2', server: 134.195.196.12, port: 5003, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
