...
proxies:
  - {name: '%F0%9F%87%B0%F0%9F%87%B7_KR_%E9%9F%A9%E5%9B%BD_1', server: kr2.futi.online, port: 2053, type: vmess, uuid: 0025ed04-5c5a-4416-b3f3-21cc1a04530d, alterId: 1, cipher: auto, tls: true, network: ws, ws-path: /, ws-headers: {Host: kr2.futi.online}}
  - {name: '🇮🇳_IN_印度_2', server: 192.46.209.215, port: 5004, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇭🇰_HK_香港_3', server: 118.107.244.112, port: 3306, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇬🇧_GB_英国_4', server: 172.99.190.87, port: 5004, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
