...
proxies:
  ...
  - {"type":"trojan","name":"🇨🇳_CN_中国->🇹🇼_TW_台湾","server":"cm-jm.okvpn.xyz","password":"8c8578b9-3d56-425d-8bcc-880c4da3600a","port":20003,"udp":true,"skip-cert-verify":true}
  - {"type":"ss","cipher":"aes-256-cfb","password":"amazonskr05","server":"52.79.164.73","port":443,"name":"🇰🇷_KR_韩国"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
