...
proxies:
  - {name: 'www.1995bb.tk_VLESS_XTLS/TLS-direct_TCP_1', server: www.1995bb.tk, port: 443, type: vless, uuid: "ead1d29b-22e9-40f3-8b4d-5888ced6eb7b", cipher: 'auto', network: tcp, tls: true, flow: xtls-rprx-direct, host: www.1995bb.tk, skip-cert-verify: true}
  - {name: 'www.1995bb.tk_VLESS_XTLS/TLS-splice_TCP_2', server: www.1995bb.tk, port: 443, type: vless, uuid: "ead1d29b-22e9-40f3-8b4d-5888ced6eb7b", cipher: 'auto', network: tcp, tls: true, flow: xtls-rprx-splice, host: www.1995bb.tk, skip-cert-verify: true}
  - {name: 'www.1995bb.tk_VLESS_WS_3', server: www.1995bb.tk, port: 443, type: vless, uuid: "ead1d29b-22e9-40f3-8b4d-5888ced6eb7b", cipher: 'auto', network: http, tls: true, path: /lavpws, host: www.1995bb.tk, skip-cert-verify: true}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - www.1995bb.tk_VLESS_XTLS/TLS-direct_TCP_1
      - www.1995bb.tk_VLESS_XTLS/TLS-splice_TCP_2
      - www.1995bb.tk_VLESS_WS_3
  - name: ♻️ 自动选择
    type: url-test
