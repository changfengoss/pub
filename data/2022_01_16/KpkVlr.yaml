...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 38.68.134.202, port: 7307, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇨🇦_CA_加拿大_2', server: 134.195.196.52, port: 8091, type: ss, cipher: aes-256-gcm, password: PCnnH6SQSnfoS27}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
