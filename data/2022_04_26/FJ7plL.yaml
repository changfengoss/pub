...
proxies:
  - {"name":"0219_1128_wulabing_kirakirasevennine_com_1","server":"kirakirasevennine.com","port":443,"type":"vmess","uuid":"67068812-0f6c-437e-ab13-f480f23bf004","alterId":13,"cipher":"auto","country":"0219_1128_wulabing_kirakirasevennine_com_1","skip-cert-verify":true,"tls":true,"network":"ws","ws-opts":{"path":"/9f21/","headers":{"host":"kirakirasevennine.com"}}}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - 0219_1128_wulabing_kirakirasevennine_com_1
  - name: ♻️ 自动选择
    type: url-test
