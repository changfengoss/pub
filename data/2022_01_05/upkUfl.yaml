...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 38.75.136.93, port: 9101, type: ss, cipher: aes-256-gcm, password: e4FCWrgpkji3QY}
  - {name: '🇺🇸_US_美国_2', server: 38.91.102.96, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇺🇸_US_美国_3', server: 38.91.102.96, port: 8882, type: ss, cipher: aes-256-gcm, password: kDWvXYZoTBcGkC4}
  - {name: '🇺🇸_US_美国_4', server: 38.91.102.86, port: 3389, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
