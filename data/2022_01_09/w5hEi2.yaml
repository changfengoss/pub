...
proxies:
  - {name: 'Relay_🇺🇸US-🇺🇸US_1821', server: c23s801.jamjams.net, port: 61173, type: vmess, uuid: 9d1043a6-e87e-4bb7-8858-c1185e9c0c3b, alterId: 0, cipher: auto, tls: false, network: tcp, ws-opts: { path: "/ws", host: c23s801.jamjams.net }}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
