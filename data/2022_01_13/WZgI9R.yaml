...
proxies:
  - {name: '🇭🇰香港 ☆☆ 04 ☆GMO☆  1.2倍率_1', server: sg-sin-krn-v2.node.inforun.work, port: 12888, type: vmess, uuid: f87311c1-3a22-4dad-b42b-a93e9279d758, alterId: 0, cipher: auto, tls: true, network: ws, ws-opts: { path: "/je5x3pBN1vez3NQudNkB", host: cdn.savoy.click }}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
