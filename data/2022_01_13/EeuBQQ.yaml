...
proxies:
  - {name: 'n_14935_1', server: 144.202.93.155, port: 14935, type: vless, uuid: "2f6c9be9-2d5b-41d0-e976-fc10b2f05a08", cipher: 'auto', network: http, path: /wis, skip-cert-verify: true}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
