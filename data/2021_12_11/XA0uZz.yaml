...
proxies:
  - {name: '🇬🇧_GB_英国_1', server: 149.7.16.10, port: 8119, type: ss, cipher: aes-256-gcm, password: cdBIDV42DCwnfIN}
  - {name: '🇯🇵_JP_日本_2', server: 85.208.108.18, port: 8118, type: ss, cipher: aes-256-gcm, password: cdBIDV42DCwnfIN}
  - {name: '🇮🇳_IN_印度_3', server: 172.105.35.61, port: 8118, type: ss, cipher: aes-256-gcm, password: cdBIDV42DCwnfIN}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
