...
proxies:
  - {name: 'wulabing_www.liu85719.tk_1', server: www.liu85719.tk, port: 1439, type: vmess, uuid: 0262a3ee-6784-4244-b731-10b8203c120c, alterId: 4, cipher: auto, tls: true, network: ws, ws-opts: { path: "/cc7104de945/", host: www.liu85719.tk }}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
