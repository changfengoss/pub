...
proxies:
  - {name: '🇧🇪_BE_比利时_1', server: 194.110.115.86, port: 47553, type: ss, cipher: aes-256-gcm, password: t2JnnFqjDMmzWurseJPgBsYY}
  - {name: '🇳🇱_NL_荷兰_2', server: 89.46.223.105, port: 47027, type: ss, cipher: aes-256-gcm, password: Vt5pBJFwdtNB26cJbTXxm88Z}
  - {name: '🇮🇳_IN_印度_3', server: 103.108.117.148, port: 46726, type: ss, cipher: aes-256-gcm, password: 2fqKbFPGHpcmMTJzGsUbsfYf}
  - {name: '🇮🇳_IN_印度_4', server: 103.108.117.117, port: 33148, type: ss, cipher: aes-256-gcm, password: CMduaFXddcQbwNAAs7xFDnc8}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
