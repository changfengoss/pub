...
proxies:
  - {name: 'twv_1', server: twv.dxmthk001.xyz, port: 443, type: vless, uuid: "9ca62000-c6c0-4677-a3df-6f2235d392de", cipher: 'auto', network: tcp, tls: true, flow: -rprx-direct, skip-cert-verify: true}
  - {name: 'hkv_2', server: hkv.dxmthk.xyz, port: 443, type: vless, uuid: "327f5fac-89db-421a-8570-0ece2988d7c0", cipher: 'auto', network: tcp, tls: true, flow: xtls-rprx-direct, skip-cert-verify: true}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
