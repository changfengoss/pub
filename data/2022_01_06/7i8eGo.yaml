...
proxies:
  ...
  - {name: '🇺🇸_US_美国_2', server: 38.75.136.93, port: 8882, type: ss, cipher: aes-256-gcm, password: kDWvXYZoTBcGkC4}
  ...
  - {name: '🇺🇸_US_美国_4', server: 38.91.102.86, port: 8000, type: ss, cipher: aes-256-gcm, password: KixLvKzwjekG00rm}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
