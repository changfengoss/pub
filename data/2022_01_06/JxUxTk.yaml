...
proxies:
  - {name: 'unicom1_1', server: 198.41.201.85, port: 443, type: vless, uuid: "aabc5962-4775-4691-b7fc-925355d1c93e", cipher: 'auto', network: http, tls: true, path: /aabc5962-4775-4691-b7fc-925355d1c93e-vless, host: summer-mountain-2334.kfcdagongzi.workers.dev, skip-cert-verify: true}
  - {name: 'unicom2_2', server: 198.41.212.72, port: 443, type: vless, uuid: "de27820a-5ef9-455c-9a26-4bedc8a12c83", cipher: 'auto', network: http, tls: true, path: /de27820a-5ef9-455c-9a26-4bedc8a12c83-vless, host: nameless-bread-e3c6.kfcdagongzi.workers.dev, skip-cert-verify: true}
  - {name: 'unicom3_3', server: 198.41.207.55, port: 443, type: vless, uuid: "04538646-fe75-42d9-95a9-9612ea2a9200", cipher: 'auto', network: http, tls: true, path: /04538646-fe75-42d9-95a9-9612ea2a9200-vless, host: tiny-night-0118.kfcdagongzi.workers.dev, skip-cert-verify: true}
  - {name: 'unicom4_4', server: unicom4.herokuapp.com, port: 443, type: vmess, uuid: e08b8935-d483-44d3-9adb-f2a9e49ccc35, alterId: 0, cipher: auto, tls: true, network: ws, ws-opts: { path: "/e08b8935-d483-44d3-9adb-f2a9e49ccc35-vmess", host: unicom4.herokuapp.com }}
  - {name: 'unicom5_5', server: unicom5.herokuapp.com, port: 443, type: vmess, uuid: c13c8243-7b77-4058-9f73-9e79ef4025b8, alterId: 0, cipher: auto, tls: true, network: ws, ws-opts: { path: "/c13c8243-7b77-4058-9f73-9e79ef4025b8-vmess", host: unicom5.herokuapp.com }}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
