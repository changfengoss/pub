...
proxies:
  - {name: '俄罗斯3：darrenliuwei.com_1', server: rrruuaab333.liuwei01.tk, port: 443, type: vmess, uuid: 5bff6f03-1d6f-4ef0-8320-3a4dd7eb4cc8, alterId: 0, cipher: auto, tls: true, network: ws, ws-path: /darren, ws-headers: {Host: rrruuaab333.liuwei01.tk}}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
