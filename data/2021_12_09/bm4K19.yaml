...
proxies:
  - {name: '🇳🇴_NO_挪威_1', server: 46.29.218.170, port: 8119, type: ss, cipher: aes-256-gcm, password: cdBIDV42DCwnfIN}
  - {name: '🇺🇸_US_美国_2', server: 38.114.114.69, port: 8080, type: ss, cipher: aes-256-gcm, password: KixLvKzwjekG00rm}
  - {name: '🇺🇸_US_美国_3', server: 38.68.135.93, port: 8080, type: ss, cipher: aes-256-gcm, password: KixLvKzwjekG00rm}
  - {name: '🇺🇸_US_美国_4', server: 38.68.135.93, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
