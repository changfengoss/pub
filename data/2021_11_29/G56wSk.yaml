...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 134.195.196.12, port: 5003, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇺🇸_US_美国_2', server: 38.91.100.200, port: 3389, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
