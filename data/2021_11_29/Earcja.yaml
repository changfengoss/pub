...
proxies:
  - {name: '🇩🇪_DE_德国_1', server: 172.105.244.165, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇺🇸_US_美国_2', server: 142.202.48.105, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
  - {name: '🇺🇸_US_美国_3', server: 38.75.137.71, port: 3389, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇨🇦_CA_加拿大_4', server: 198.57.27.218, port: 8090, type: ss, cipher: aes-256-gcm, password: PCnnH6SQSnfoS27}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
