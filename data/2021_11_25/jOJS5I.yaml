...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 142.202.48.55, port: 5003, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇨🇦_CA_加拿大_2', server: 198.57.27.191, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇺🇸_US_美国_3', server: 38.75.136.93, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
  - {name: '🇨🇦_CA_加拿大_4', server: 134.195.196.52, port: 3389, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
