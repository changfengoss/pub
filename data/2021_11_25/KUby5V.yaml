...
proxies:
  ...
  - {name: '🇺🇸_US_美国_2', server: 38.68.134.191, port: 2375, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇨🇦_CA_加拿大_3', server: 134.195.196.3, port: 8091, type: ss, cipher: aes-256-gcm, password: PCnnH6SQSnfoS27}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
