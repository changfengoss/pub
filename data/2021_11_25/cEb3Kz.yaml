...
proxies:
  - {name: '🇮🇳_IN_印度_1', server: 45.79.121.166, port: 7306, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇺🇸_US_美国_2', server: 38.75.137.71, port: 8090, type: ss, cipher: aes-256-gcm, password: PCnnH6SQSnfoS27}
  - {name: '🇨🇦_CA_加拿大_3', server: 134.195.196.51, port: 7307, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇩🇪_DE_德国_4', server: 193.108.118.2, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
