...
proxies:
  - {"name":"github_com/freefq+-+澳大利亚悉尼Oracle云计算数据中心+36_1","server":"jgwxn3.gaox.ml","port":443,"type":"trojan","country":"github_com/freefq+-+澳大利亚悉尼Oracle云计算数据中心+36_1","skip-cert-verify":true,"udp":true,"password":"cb43b7c2-b744-41c5-bcc2-fd7467b332cf"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - github_com/freefq+-+澳大利亚悉尼Oracle云计算数据中心+36_1
  - name: ♻️ 自动选择
    type: url-test
