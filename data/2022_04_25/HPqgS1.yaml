...
proxies:
  - {"name":"defaultName_1","server":"45.77.98.246","port":9846,"type":"ssr","country":"defaultName_1","password":"156/*","cipher":"aes-256-cfb","protocol":"auth_aes128_sha1","obfs":"http_simple"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
