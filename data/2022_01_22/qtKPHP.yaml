...
proxies:
  ...
  - {name: '🇺🇸_US_美国_2', server: 38.75.136.58, port: 7307, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇺🇸_US_美国_3', server: 167.88.61.60, port: 8118, type: ss, cipher: aes-256-gcm, password: cdBIDV42DCwnfIN}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
