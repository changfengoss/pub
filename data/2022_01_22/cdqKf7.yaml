...
proxies:
  - {name: 'n_000_1', server: xiaolingms.top, port: 443, type: vless, uuid: "6354213a-6a8f-4b59-c5df-681bf56b41c9", cipher: 'auto', network: http, tls: true, path: /fileWs/, skip-cert-verify: true}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
