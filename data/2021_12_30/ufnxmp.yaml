...
proxies:
  - {name: 'vickel_1', server: vickel.top, port: 23464, type: vless, uuid: "25137158-62ca-4822-b766-e4578b915a28", cipher: 'auto', network: tcp, tls: true, flow: xtls-rprx-direct, skip-cert-verify: true}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
