...
proxies:
  ...
  - {name: '🇺🇸_US_美国_2', server: 38.64.138.145, port: 5600, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇺🇸_US_美国_3', server: 38.143.66.71, port: 7002, type: ss, cipher: aes-256-gcm, password: RexnBgU7EV5ADxG}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
