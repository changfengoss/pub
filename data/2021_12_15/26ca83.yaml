...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 104.26.9.74, port: 443, type: vmess, uuid: f6c1babe-416e-47d1-8726-049678e25c7a, alterId: 64, cipher: auto, tls: true, network: ws, ws-path: /sshocean, ws-headers: {Host: us2.v2rayserv.com}}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
