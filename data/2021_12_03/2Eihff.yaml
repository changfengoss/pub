...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 134.195.196.3, port: 8091, type: ss, cipher: aes-256-gcm, password: PCnnH6SQSnfoS27}
  - {name: '🇨🇦_CA_加拿大_2', server: 198.57.27.241, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇩🇪_DE_德国_3', server: 93.186.201.158, port: 811, type: ss, cipher: chacha20-ietf-poly1305, password: G!yBwPWH3Vao}
  - {name: '🇸🇬_SG_新加坡_4', server: 81.90.189.57, port: 809, type: ss, cipher: chacha20-ietf-poly1305, password: G!yBwPWH3Vao}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
