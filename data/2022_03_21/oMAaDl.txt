...
proxies: 
  - { name: '%E9%A6%99%E6%B8%AF_1', server: '34.150.94.76', port: 443, type: vless, uuid: 'd04ab6eb-0a92-4988-d827-4e085b8cc8d0', cipher: 'auto', skip-cert-verify: true, network: tcp }
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
