...
proxies: 
  - {name: '', server: '27.102.106.91', port: 443, type: vmess, uuid: '6cd76002-bc6e-4c71-9d10-f99bc580113b', alterId: 0, cipher: auto, country: "", "skip-cert-verify": true, tls: true, network: 'ws', ws-opts: { path: '/ptIF9jrOvr59', headers: {host: 'laowxxxx.xyz'}} }
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
