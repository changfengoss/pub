...
proxies:
  - {name: '🇫🇷_FR_法国_1', server: 217.182.199.168, port: 8888, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇺🇸_US_美国_2', server: 142.202.48.43, port: 8090, type: ss, cipher: aes-256-gcm, password: PCnnH6SQSnfoS27}
  - {name: '🇨🇦_CA_加拿大_3', server: 134.195.196.51, port: 5004, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇨🇦_CA_加拿大_4', server: 198.57.27.218, port: 7306, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
