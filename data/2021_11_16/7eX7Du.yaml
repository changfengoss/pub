  ...
  proxies:
    - {name: 'n__1', server: tokyo1.purinbot.store, port: 1919, type: vmess, uuid: fe7b5300-4644-11ec-af8f-5346e788f0fc, alterId: 0, cipher: auto, tls: true, network: ws, ws-path: /s2fqAJKV/, ws-headers: {Host: speedtest.net}}
  proxy-groups:
    - name: 🔰 节点选择
      type: select
      proxies:
