...
proxies:
  - {"name":"🇯🇵_JP_日本_1","server":"jp2.mayiyun.vip","port":80,"type":"vmess","uuid":"54b3ef87-0084-4362-af57-2fb494d8ca15","alterId":0,"cipher":"auto","country":"🇯🇵_JP_日本_1","skip-cert-verify":true,"tls":false,"network":"ws","ws-opts":{"headers":{"host":"shoutingtoutiao3.10010.com"}}}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
