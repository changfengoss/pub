...
proxies:
  - {name: '🇭🇰_HK_香港_1', server: 118.107.244.112, port: 5601, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇨🇦_CA_加拿大_2', server: 198.57.27.218, port: 2375, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇺🇸_US_美国_3', server: 38.75.136.93, port: 9101, type: ss, cipher: aes-256-gcm, password: e4FCWrgpkji3QY}
  - {name: '🇺🇸_US_美国_4', server: 167.88.61.60, port: 6679, type: ss, cipher: aes-256-gcm, password: TEzjfAYq2IjtuoS}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
