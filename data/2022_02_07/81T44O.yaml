...
proxies:
  - {"name":"🇺🇸_US_美国_1","server":"167.88.63.28","port":7306,"type":"ss","cipher":"aes-256-gcm","password":"FoOiGlkAA9yPEGP"}
  - {"name":"🇺🇸_US_美国_2","server":"38.121.43.71","port":8091,"type":"ss","cipher":"aes-256-gcm","password":"PCnnH6SQSnfoS27"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
