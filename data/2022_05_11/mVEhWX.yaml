...
proxies:
  - {"type":"ss","cipher":"aes-256-gcm","password":"pKEW8JPByTVTLtM","server":"134.195.196.205","port":443,"name":"🇨🇦_CA_加拿大"}
  - {"type":"ss","cipher":"aes-256-cfb","password":"HSZuyJQcWe8dxNdF","server":"185.167.116.253","port":9043,"name":"🇦🇺_AU_澳大利亚"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
