...
proxies: 
  - { name: 'bj_mneuw_top_VLESS_XTLS/TLS-direct_TCP_1', server: 'bj.mneuw.top', port: 443, type: vless, uuid: 'de1f4cc8-e2a5-44b4-9302-793339ee1d90', cipher: 'auto', skip-cert-verify: true, tls: true, flow: 'xtls-rprx-direct', host: 'bj.mneuw.top', network: tcp }
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - bj_mneuw_top_VLESS_XTLS/TLS-direct_TCP_1
  - name: ♻️ 自动选择
    type: url-test
