...
proxies:
  - {name: '🇧🇪_BE_比利时_1', server: 194.110.115.86, port: 41992, type: ss, cipher: aes-256-gcm, password: XmQSxDCn5ehpcq6DBYms8FJf}
  - {name: '🇧🇪_BE_比利时_2', server: 194.110.115.86, port: 48970, type: ss, cipher: aes-256-gcm, password: ZKEsXkFbUZ2z667YA8A7cEDP}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
