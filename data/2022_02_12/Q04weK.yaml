...
proxies:
  - {"name":"🇯🇵_JP_日本_1","server":"lin-jp.tgsc.xyz","port":443,"type":"vmess","uuid":"57c95541-5147-4dae-81d0-660cc6b25e9b","alterId":0,"cipher":"auto","tls":true,"network":"ws","ws-opts":{"path":"/FNRWR48K"}}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
