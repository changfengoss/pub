...
proxies:
  - {name: 'SSRTOOL 公益站 - 剩余流量：17.84GB_1', server: portx.cc, port: 10086group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: chacha20-ietf, password: vhseYB9MlEmYsY9L}
  - {name: 'SSRTOOL 公益站 - 过期时间：2022-05-21_2', server: portx.cc, port: 10086group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: chacha20-ietf, password: vhseYB9MlEmYsY9L}
  - {name: 'SSRTOOL 公益站 - 新加坡 01_3', server: bj.portx.cc, port: 45009group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: aes-256-gcm, password: vhseYB9MlEmYsY9L}
  - {name: 'SSRTOOL 公益站 - 美国 俄勒冈 01_4', server: cs.portx.cc, port: 25049group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: aes-256-gcm, password: vhseYB9MlEmYsY9L}
  - {name: 'SSRTOOL 公益站 - 美国 俄勒冈 02_5', server: cs.portx.cc, port: 25050group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: aes-256-gcm, password: vhseYB9MlEmYsY9L}
  - {name: 'SSRTOOL 公益站 - 美国 俄勒冈 03_6', server: cs.portx.cc, port: 25051group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: aes-256-gcm, password: vhseYB9MlEmYsY9L}
  - {name: 'SSRTOOL 公益站 - 美国 俄勒冈 04_7', server: cs.portx.cc, port: 25035group=U1NSVE9PTCDlhaznm4rnq5k, type: ss, cipher: aes-256-gcm, password: vhseYB9MlEmYsY9L}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - SSRTOOL 公益站 - 剩余流量：17.84GB_1
      - SSRTOOL 公益站 - 过期时间：2022-05-21_2
      - SSRTOOL 公益站 - 新加坡 01_3
      - SSRTOOL 公益站 - 美国 俄勒冈 01_4
      - SSRTOOL 公益站 - 美国 俄勒冈 02_5
      - SSRTOOL 公益站 - 美国 俄勒冈 03_6
      - SSRTOOL 公益站 - 美国 俄勒冈 04_7
  - name: ♻️ 自动选择
    type: url-test
