...
proxies:
  - {name: '🇳🇱_NL_荷兰_1', server: 89.46.223.73, port: 34815, type: ss, cipher: aes-256-gcm, password: LkFAzkzXkSCRYa2CsRdL8cGb}
  - {name: '🇨🇦_CA_加拿大_2', server: 37.19.211.85, port: 50181, type: ss, cipher: aes-256-gcm, password: d9adRr9UxymNSysYahMtpFpd}
  - {name: '🇨🇦_CA_加拿大_3', server: 37.19.211.63, port: 45291, type: ss, cipher: aes-256-gcm, password: ecfJrNtBZwT748hxJ3ZyzZj2}
  - {name: '🇳🇱_NL_荷兰_4', server: 89.46.223.246, port: 49396, type: ss, cipher: aes-256-gcm, password: BdRWC38L5JUDMTYNNxJGcUwB}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
