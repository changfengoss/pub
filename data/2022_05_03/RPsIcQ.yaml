...
proxies:
  - {"name":"www_dongtaiwang_com免费ssr节点_1","server":"ssrfree10.free4444.xyz","port":443,"type":"ssr","country":"www_dongtaiwang_com免费ssr节点_1","password":"dongtaiwang.com","cipher":"dummy","protocol":"auth_chain_a","obfs":"tls1.2_ticket_auth"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
