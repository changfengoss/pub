...
proxies:
  ...
  - {name: '🇭🇰_HK_香港->🇰🇷_KR_韩国_3', server: xe3rayu3.com, port: 443, type: vmess, uuid: aba50dd4-5484-3b05-b14a-4661caf862d5, alterId: 4, cipher: auto, tls: true, network: ws, ws-path: /ws, ws-headers: {Host: xe3rayu3.com}}
  ...
  - {name: '🇭🇰_HK_香港_7', server: 84.17.37.55, port: 8389, type: ss, cipher: chacha20-ietf-poly1305, password: tjwRqQvteAjt3xFmbZTA}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
