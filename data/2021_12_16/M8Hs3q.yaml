...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 184.75.208.234, port: 8388, type: ss, cipher: chacha20-ietf-poly1305, password: 47GH3wQRw7V4Zhd35bFs}
  ...
  - {name: '🇺🇸_US_美国_4', server: api.ssfree.ru, port: 443, type: vmess, uuid: 104595ae-5dc0-11ec-ac30-000017022008, alterId: 64, cipher: auto, tls: true, network: ws, ws-path: /getweather}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
