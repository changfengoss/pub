...
proxies:
  - {name: '🇬🇧_GB_英国_1', server: 172.99.190.87, port: 5004, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇫🇷_FR_法国_2', server: 62.210.209.50, port: 6697, type: ss, cipher: aes-256-gcm, password: TEzjfAYq2IjtuoS}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
