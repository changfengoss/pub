...
proxies:
  - {name: '🇳🇴_NO_挪威_1', server: 46.29.218.6, port: 7306, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇬🇧_GB_英国_2', server: 172.99.190.87, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇳🇴_NO_挪威_3', server: 46.29.218.6, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
  - {name: '🇫🇷_FR_法国_4', server: 145.239.1.137, port: 8080, type: ss, cipher: aes-256-gcm, password: KixLvKzwjekG00rm}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
