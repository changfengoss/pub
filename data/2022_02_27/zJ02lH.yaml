...
proxies:
  - {"name":"default_name_1","server":"cm.db-link.in","port":443,"type":"vmess","uuid":"a9a8f171-6284-3965-a023-c5e978e084a5","alterId":1,"cipher":"auto","tls":true,"network":"ws","ws-opts":{"path":"/db","headers":{"host":"us01.db-link.in"}}}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
