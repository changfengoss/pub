...
proxies:
  - {name: 'lm_1', server: 43.154.73.113, port: 34468, type: vmess, uuid: fd86d50c-1454-4834-91e8-6c202d9a7c82, alterId: 0, cipher: auto, tls: false, network: kcp, ws-path: 6kPjQRo1BR}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
