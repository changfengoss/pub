...
proxies:
  - {name: '🇨🇭_CH_瑞士_1', server: 156.146.62.50, port: 45948, type: ss, cipher: aes-256-gcm, password: j76EXqJcQhuQTr3EvUf7xaK9}
  - {name: '🇩🇪_DE_德国_2', server: 82.102.16.102, port: 49514, type: ss, cipher: aes-256-gcm, password: dpGjA4GkzV28QPDYzEp94cTe}
  - {name: '🇸🇰_SK_斯洛伐克_3', server: 185.76.8.218, port: 38742, type: ss, cipher: aes-256-gcm, password: DKXfWwc4ebscpXTKpbt85rSH}
  - {name: '🇬🇧_GB_英国_4', server: 217.146.83.66, port: 44745, type: ss, cipher: aes-256-gcm, password: fyXdw87yCH9SAmFkPvsvLVqC}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
