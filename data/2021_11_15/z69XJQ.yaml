...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 138.199.42.170, port: 49514, type: ss, cipher: aes-256-gcm, password: dpGjA4GkzV28QPDYzEp94cTe}
  - {name: '🇨🇭_CH_瑞士_2', server: 156.146.62.50, port: 38747, type: ss, cipher: aes-256-gcm, password: RtbLkxbJZpUQ6m8y4qAeLYZj}
  - {name: '🇨🇭_CH_瑞士_3', server: 156.146.62.50, port: 31764, type: ss, cipher: aes-256-gcm, password: YgusH2MWA8PWc3p2VDsR7AVv}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
