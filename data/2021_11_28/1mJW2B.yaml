...
proxies:
  - {name: 'meg宝宝_bit_1', server: bit.wwhyme.com, port: 51779, type: vmess, uuid: 8b628910-e736-4943-fa9f-5ae2a801e864, alterId: 64, cipher: auto, tls: true, network: ws, ws-path: /meg}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
