...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 167.88.63.74, port: 3389, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇺🇸_US_美国_2', server: 167.88.63.89, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
