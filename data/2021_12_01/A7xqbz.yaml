...
proxies:
  - {name: '🇺🇸_US_美国_1', server: 38.75.136.21, port: 5003, type: ss, cipher: aes-256-gcm, password: g5MeD6Ft3CWlJId}
  - {name: '🇯🇵_JP_日本_2', server: 85.208.108.194, port: 6697, type: ss, cipher: aes-256-gcm, password: TEzjfAYq2IjtuoS}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
