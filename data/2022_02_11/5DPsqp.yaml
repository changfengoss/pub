...
proxies:
  - {"name":"台湾HiNet3[x0_75_NF_V2Ray]at480Mbps_1","server":"br-cn-east-cu1.node-fnf.xyz","port":10206,"type":"vmess","uuid":"f6bce115-e616-302c-84bb-0f51d4af3972","alterId":1,"cipher":"auto","tls":false,"network":"tcp"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - 台湾HiNet3[x0_75_NF_V2Ray]at480Mbps_1
  - name: ♻️ 自动选择
    type: url-test
