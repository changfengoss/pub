...
proxies:
  - {name: '🇦🇺_AU_澳大利亚_1', server: 192.53.169.116, port: 8080, type: ss, cipher: aes-256-gcm, password: KixLvKzwjekG00rm}
  - {name: '🇮🇳_IN_印度_2', server: 192.46.209.227, port: 6679, type: ss, cipher: aes-256-gcm, password: TEzjfAYq2IjtuoS}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
