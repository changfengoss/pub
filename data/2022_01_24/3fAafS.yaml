...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 134.195.196.71, port: 6697, type: ss, cipher: aes-256-gcm, password: TEzjfAYq2IjtuoS}
  - {name: '🇨🇦_CA_加拿大_2', server: 198.57.27.241, port: 7306, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇺🇸_US_美国_3', server: 167.88.63.28, port: 3389, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇺🇸_US_美国_4', server: 38.68.134.191, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
