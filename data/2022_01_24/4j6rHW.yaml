...
proxies:
  - {name: '🇬🇧_GB_英国_1', server: 172.99.190.186, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
  - {name: '🇩🇪_DE_德国_2', server: 193.108.118.2, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
