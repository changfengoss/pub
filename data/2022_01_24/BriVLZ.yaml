...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 198.57.27.184, port: 2376, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
  - {name: '🇫🇷_FR_法国_2', server: 62.210.209.50, port: 7307, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇯🇵_JP_日本_3', server: 45.11.1.158, port: 8881, type: ss, cipher: aes-256-gcm, password: kDWvXYZoTBcGkC4}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
