...
proxies:
  - {name: 'w.1995bb.tk_VLESS_XTLS/TLS-direct_TCP_1', server: w.1995bb.tk, port: 443, type: vless, uuid: "dd99e159-c18f-4ca0-8c85-bb667ba1503d", cipher: 'auto', network: tcp, tls: true, flow: xtls-rprx-direct, host: w.1995bb.tk, skip-cert-verify: true}
  - {name: 'w.1995bb.tk_VLESS_gRPC_2', server: w.1995bb.tk, port: 443, type: vless, uuid: "dd99e159-c18f-4ca0-8c85-bb667ba1503d", cipher: 'auto', network: tcp, tls: true, path: tvrygrpc, host: w.1995bb.tk, skip-cert-verify: true}
  - {name: 'w.1995bb.tk_Trojan_3', server: w.1995bb.tk, port: 443, type: trojan, password: dd99e159-c18f-4ca0-8c85-bb667ba1503d, sni: w.1995bb.tk&alpn=http1.1}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - w.1995bb.tk_VLESS_XTLS/TLS-direct_TCP_1
      - w.1995bb.tk_VLESS_gRPC_2
      - w.1995bb.tk_Trojan_3
  - name: ♻️ 自动选择
    type: url-test
