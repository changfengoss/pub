...
proxies: 
  - { name: '%e7%be%8e1_1', server: '104.16.28.152', port: 443, type: vless, uuid: '21db3f3d-4f4b-42b1-b2e2-59a342ff7eeb', cipher: 'auto', skip-cert-verify: true, tls: true, path: '/', host: 'wandering-hat-8bb1.houyu08185766.workers.dev', network: http }
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
