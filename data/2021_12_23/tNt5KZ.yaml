...
proxies:
  - {name: '🇫🇷_FR_法国_1', server: 141.95.0.23, port: 812, type: ss, cipher: chacha20-ietf-poly1305, password: G!yBwPWH3Vao}
  - {name: '🇫🇷_FR_法国_2', server: 145.239.1.137, port: 443, type: ss, cipher: aes-256-gcm, password: pKEW8JPByTVTLtM}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
