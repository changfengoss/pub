...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 134.195.196.33, port: 3306, type: ss, cipher: aes-256-gcm, password: Y6R9pAtvxxzmGC}
  - {name: '🇺🇸_US_美国_2', server: 142.202.48.52, port: 7307, type: ss, cipher: aes-256-gcm, password: FoOiGlkAA9yPEGP}
  - {name: '🇫🇷_FR_法国_3', server: 141.95.0.23, port: 811, type: ss, cipher: chacha20-ietf-poly1305, password: G!yBwPWH3Vao}
  - {name: '🇺🇸_US_美国_4', server: 167.88.63.71, port: 2375, type: ss, cipher: aes-256-gcm, password: faBAoD54k87UJG7}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
