...
proxies:
  - {name: '🇨🇦_CA_加拿大_1', server: 37.19.211.65, port: 49126, type: ss, cipher: aes-256-gcm, password: wrCaGtrUbzeRqQLdc8Kmk3Nd}
  - {name: '🇳🇱_NL_荷兰_2', server: 89.46.223.65, port: 38747, type: ss, cipher: aes-256-gcm, password: RtbLkxbJZpUQ6m8y4qAeLYZj}
  - {name: '🇨🇦_CA_加拿大_3', server: 37.19.211.28, port: 50695, type: ss, cipher: aes-256-gcm, password: gqtwGu9bVreJqL3FTHSVKGzy}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
